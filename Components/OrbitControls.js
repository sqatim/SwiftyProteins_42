...
const logFunction = (state) => {
  if (state == -1) console.log("NONE");
  if (state == 0) console.log("ROTATE");
  if (state == 1) console.log("DOLLY");
  if (state == 2) console.log("PAN");
  if (state == 3) console.log("TOUCH_ROTATE");
  if (state == 4) console.log("TOUCH_PAN");
  if (state == 5) console.log("TOUCH_DOLLY_PAN");
  if (state == 6) console.log("TOUCH_DOLLY_ROTATE");
};
...
export class OrbitControls extends EventDispatcher {
  constructor(object, ref) {
    ...
    this.handleTouchMoveDollyPan = (event, gestureState) => {
      if (this.enableZoom) this.handleTouchMoveDolly(event, gestureState);
    ...
    this.onTouchStart = (event, gestureState) => {
      var _a, _b;
      if (this.enabled === false) return;
      (_b = (_a = event).preventDefault) === null || _b === void 0
        ? void 0
    ...
    this.onTouchMove = (event, gestureState) => {
      var _a, _b, _c, _d;
      if (this.enabled === false) return;
      (_b = (_a = event).preventDefault) === null || _b === void 0
        ? void 0
